...
(function($) {
	...
	var defaults = {
		...
		tmpl_path: 'http://localhost:8888/tmpls/',
		tmpl_cache: true,
		classes: {
			months: {
	...
	Calendar.prototype._update = function() {
		...
		$('.cal-cell').dblclick(function() {
			...
			self.view(view);
			// console.log('#'+self.options.day+'-afternoon');

			// var sign = $('#'+self.options.day+'-afternoon').prop('class');
			// if(sign === 'glyphicon glyphicon-star scheduleSign2') {
			// 	$('#'+self.options.day+'-afternoon').prop('class', 'glyphicon glyphicon-heart scheduleSign2');
			// }
			// else {
			// 	$('#'+self.options.day+'-afternoon').prop('class', 'glyphicon glyphicon-star scheduleSign2');	
			// }
		});
