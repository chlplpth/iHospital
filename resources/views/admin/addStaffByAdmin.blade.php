  ...
  <div class="panel-body">
    <div id="addStaffForm">
      <div class="form-group row">
        <div class="col-xs-1">{!! Form::label('name', 'ชื่อ'); !!}</div>
      ...
      <div class="form-group row">
        <div class="col-xs-1">{!! Form::label('surname', 'นามสกุล'); !!}</div>
      ...
      <div class="form-group row">
        <div class="col-xs-1">{!! Form::label('userType', 'บทบาท'); !!}</div>
      ...
      <div class="form-group row">
        <div class="col-xs-1">{!! Form::label('department', 'แผนก'); !!}</div>
        <div class="col-xs-3">{!! Form::select('departmentId', $department, null, ["class" => "form-control"]) !!}</div>
      </div>
      <div class="form-group row">
        <div class="col-xs-1">{!! Form::label('username', 'ชื่อผู้ใช้'); !!}</div>
      ...
      <div class="form-group row">
        <div class="col-xs-1">{!! Form::label('email', 'อีเมล'); !!}</div>
