...
<div class="panel panel-default">
  ...
  <div class="panel-body form">
    <div id="addMedForm">
      ...
      <div class="form-group row">
        <div class="col-xs-2">{!! Form::label('medicineName', 'ชื่อยา'); !!}</div>
      ...
      <div class="form-group row">
        <div class="col-xs-2">{!! Form::label('medicineType', 'ประเภทยา'); !!}</div>
      ...
      <div class="form-group row">
        <div class="col-xs-2">{!! Form::label('description', 'รายละเอียดยา'); !!}</div>
