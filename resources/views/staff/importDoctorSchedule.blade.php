	...
	<div class="panel-body" style="margin-left:40px; margin-top:2%;">
			...
			@else
				...
				<div class="form-group row">
					...
					<div class="col-xs-2" id="staffLabel">{{ $doctor->staffId }}</div>
				</div>
				<div class="form-group row">
					<div class="col-xs-2" id="staffLabel">{!! Form::label('name', 'ชื่อ'); !!}</div>
					<div class="col-xs-2" id="staffLabel">{{ $doctor->name }}</div>
				</div>
				<div class="form-group row">
					<div class="col-xs-2" id="staffLabel">{!! Form::label('surname', 'นามสกุล'); !!}</div>
					<div class="col-xs-2" id="staffLabel">{{ $doctor->surname }}</div>
				</div>
				<div class="form-group row">
